...
// for changing languages
	...
	$( function() {
  	...
  	{
  		$(elem).siblings().removeClass("rotated-10",500, "easeOutBounce");
  		$(elem).siblings().addClass("smallable",500, "easeOutBounce");
		
  			
  	}
  	function un_make_small(elem)
  	{
  		if ($(elem).siblings().hasClass("normaly_rotated")) 
  		{
  		$(elem).siblings().addClass("rotated-10",500, "easeOutBounce");	
  		}
  		$(elem).siblings().removeClass("smallable",600, "easeOutBounce");
