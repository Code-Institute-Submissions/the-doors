...
// for changing languages
	...
	$( function() {
  	...
  	function un_rotated(elem)
  	{
  		...
  		{  		
  			$(elem).removeClass("rotated-10",500, "easeOutBounce");
		}
  	}
  	function make_small(elem)
  	{
  		
			$(elem).addClass("smallable",500, "easeOutBounce");
		
  	}
  	function make_small_most_left(elem)
  	{
  			$(elem).addClass("smallable_3d_most_left",500, "easeOutBounce");
  	}
  	function make_small_just_left(elem)
  	{
  			$(elem).addClass("smallable_3d_left",500, "easeOutBounce");
  	}
  	function make_small_just_right(elem)
  	{
			$(elem).addClass("smallable_3d_right",500, "easeOutBounce");
  	}
  	function make_small_most_right(elem)
  	{
			$(elem).addClass("smallable_3d_most_right",500, "easeOutBounce");
  	}
  	...
  	function un_make_small(elem)
  	{
  		if ($(elem).hasClass("rotated-10"))
  		{  		
  		$(elem).addClass("rotated-10",500, "easeOutBounce");	
  		}
  		$(elem).removeClass("smallable",600, "easeOutBounce");
  		
  	}
  	function un_make_small_most_left(elem)
  	{
  			$(elem).removeClass("smallable_3d_most_left",500, "easeOutBounce");
  	}
  	function un_make_small_just_left(elem)
  	{
  			$(elem).removeClass("smallable_3d_left",500, "easeOutBounce");
  	}
  	function un_make_small_just_right(elem)
  	{
			$(elem).removeClass("smallable_3d_right",500, "easeOutBounce");
  	}
  	function un_make_small_most_right(elem)
  	{
			$(elem).removeClass("smallable_3d_most_right",500, "easeOutBounce");
  	}
